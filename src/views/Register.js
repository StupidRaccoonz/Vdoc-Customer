...
const Register = props => {
  ...
  const [phone_with_code_value, setPhoneWithCodeValue] = useState(
    route.params.phone_with_code_value,
  );
  const [phone_number_value, setPhoneNumber] = useState(
    route.params.phone_number_value,
  );
  ...
  const register = async () => {
    ...
    await axios({
      ...
      data: {
        ...
        phone_with_code: phone_with_code_value,
  ...
  const saveData = async data => {
    try {
      ...
      await AsyncStorage.setItem(
        'phone_with_code',
        data.result.phone_with_code.toString(),
      );
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView
        ...
        <Text
          style={{fontSize: 20, color: colors.theme_fg_two, fontFamily: bold}}>
          Register
        </Text>
        ...
        <View>
          ...
          <View style={styles.genderFieldcontainer}>
            <Picker
              ...
              style={styles.genderFieldcontainer}
              dropdownIconColor={colors.theme_fg}
              onValueChange={(itemValue, itemIndex) =>
                select_gender(itemValue)
              }>
              <Picker.Item
                style={{
                  fontSize: 12,
          ...
          <CustomButton onPress={check_validation} label="Sign Up" />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
