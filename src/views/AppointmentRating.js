...
import { regular, bold, api_url, hospital_rating } from '../config/Constants';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={{ alignItems:'center'}}>
          <Text style={{ color:colors.grey, fontFamily:bold, fontSize:14 }}>{data.title}</Text>
          <View style={{ margin:5 }} />
          <Text style={{ color:colors.grey, fontFamily:bold, fontSize:14 }}>{data.description}</Text>
        </View>
