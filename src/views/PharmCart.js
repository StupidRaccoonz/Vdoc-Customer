...
} from '../actions/PharmOrderActions';
...
const PharmCart = props => {
  ...
  const add_to_cart = async (
    ...
    let old_item_details = await cart_items[
      props.cart_items.findIndex(x => x.product_id == item_id)
    ];
    ...
    if (old_item_details != undefined && total_price > 0) {
      console.log('1');
      sub_total =
        (await parseFloat(sub_total)) - parseFloat(old_item_details.price);
    ...
    if (qty > 0) {
      ...
      cart_items[props.cart_items.findIndex(x => x.product_id == item_id)] =
        await item;
    ...
    <SafeAreaView style={styles.container}>
        ...
        {props.cart_items.map((row, index) => (
          <View
            ...
            <View
              ...
              <Text
                numberOfLines={2}
                style={{color: colors.black, fontFamily: bold, fontSize: 16}}>
                {row.product_name}
              </Text>
              <View style={{margin: 2}} />
            </View>
        ...
        {!props.promo ? (
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{color: colors.success, fontFamily: bold, fontSize: 14}}>
                Code {props.promo.promo_code} applied!
              </Text>
              <View style={{margin: 2}} />
              <Text
                style={{color: colors.grey, fontFamily: regular, fontSize: 12}}>
        ...
        <View style={{padding: 10}}>
          <View style={{width: '100%', flexDirection: 'row'}}>
            <View
              ...
              <Text
                style={{fontSize: 14, color: colors.grey, fontFamily: regular}}>
                Sub Total
              </Text>
            </View>
            <View
          ...
          <View style={{margin: 10}} />
          <View
            style={{borderBottomWidth: 1, borderColor: colors.light_grey}}
          />
          <View style={{margin: 10}} />
          <View style={{width: '100%', flexDirection: 'row'}}>
            <View
      ...
      {props.address ? (
        <TouchableOpacity
          ...
          <CustomButton label="Place order" onPress={change_address} />
        </TouchableOpacity>
      ) : (
        <View
          style={{
          ...
          <CustomButton label="Select address" onPress={change_address} />
        </View>
      )}
    </SafeAreaView>
  );
