...
const HospitalDetails = props => {
    ...
    return data.departments.map(val => {
      return (
        <View style={{flexDirection: 'row', margin: 10}}>
          <View
            style={{width: '10%', flexDirection: 'row', alignItems: 'center'}}>
            <Image
              source={{uri: img_url + val.image}}
        ...
        <View
          ...
          <View style={{width: '70%', justifyContent: 'flex-start'}}>
            ...
            <Text
              ...
              {val.specialist} - {val.sub_specialist}
            </Text>
            <View style={{margin: 3}} />
            <View style={{flexDirection: 'row'}}>
              {val.appointment_status == 1 && (
                <TouchableOpacity
                  activeOpacity={1}
                  onPress={create_appointment.bind(this, val)}
                  style={{
                    alignItems: 'center',
                    justifyContent: 'center',
                    width: 100,
              ...
              <TouchableOpacity
                activeOpacity={1}
                onPress={view_doctor_details.bind(this, val)}
                style={{
                  alignItems: 'center',
                  justifyContent: 'center',
                  width: 100,
      ...
      return (
        <View style={{flexDirection: 'row', margin: 10}}>
          <View
            style={{width: '10%', flexDirection: 'row', alignItems: 'center'}}>
            <Image
              source={{uri: img_url + val.service_icon}}
              style={{height: 20, width: 20, borderRadius: 5}}
            />
          </View>
  ...
  const insurances = () => {
    return data.insurances.map(val => {
      return (
        <TouchableOpacity
          onPress={redirect_website.bind(this, val.insurance_link)}
          style={{
            alignItems: 'center',
            margin: 5,
            width: 90,
          ...
          <Image
            source={{uri: img_url + val.insurance_logo}}
            style={{
              height: 70,
              width: 70,
              borderRadius: 5,
      ...
      <ScrollView>
        <CardView
          ...
          <View style={{flexDirection: 'row', padding: 10}}>
            ...
            <View
              ...
              <View style={{margin: 2}} />
              <Text
                style={{fontFamily: regular, fontSize: 12, color: colors.grey}}>
                {data.address}
              </Text>
              <View style={{margin: 5}} />
          ...
          <View style={{padding: 10}}>
            ...
            <View style={{margin: 5}} />
            <TouchableOpacity
              onPress={redirect_phone.bind(this, data.phone_with_code)}
              ...
              <View
                ...
                <Icon
                  type={Icons.Ionicons}
                  name="call-outline"
                  style={{fontSize: 20, color: colors.theme_fg_two}}
                />
                <View style={{margin: 5}} />
                <Text
                  style={{
            ...
            <View style={{margin: 3}} />
            <TouchableOpacity
              onPress={redirect_email.bind(this, data.email)}
              style={{flexDirection: 'row'}}>
              <View
                style={{
                  width: '30%',
            ...
            {data.website && (
              <TouchableOpacity
                onPress={redirect_website.bind(this, data.website)}
                style={{flexDirection: 'row'}}>
                <View
                  style={{
                    width: '30%',
          ...
          <TouchableOpacity
            ...
            <Text
              style={{fontFamily: bold, fontSize: 14, color: colors.theme_fg}}>
              Contact Number
            </Text>
          </TouchableOpacity>
          <View style={{margin: 10}} />
        ...
        {data.our_labs.length > 0 && (
          <CardView
            ...
            <View style={{padding: 10}}>
              <Text
                style={{fontFamily: bold, fontSize: 15, color: colors.grey}}>
                Our Labs
              </Text>
              <View style={{margin: 5}} />
              <ScrollView
