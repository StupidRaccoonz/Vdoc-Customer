...
const DoctorList = props => {
    ...
    return dates.map(data => {
      ...
      return (
        <TouchableOpacity
          ...
          style={data == date ? styles.active_badge : styles.in_active_badge}>
          <Text
            style={data == date ? styles.active_text : styles.in_active_text}>
            {cur_date}
          </Text>
          <View style={{margin: 1}} />
          <Text
  ...
  const render_online_doctors = ({item}) => (
    <TouchableOpacity
      ...
      style={{margin: 10}}>
      <CardView cardElevation={5} cardMaxElevation={10} cornerRadius={10}>
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Text style={{color: colors.theme_bg}}>
                {global.currency}
                {item.consultation_fee} per Consultation
              </Text>
            </View>
            <View style={{marginTop: 6}}>
              <Text style={{color: colors.clrGrey}}>
            ...
            <View
              ...
              <Text style={{fontSize: 12}}>{item.qualification}</Text>
            </View>
          </View>
        </View>
                ...
                <View
                  ...
                  <View
                    ...
                    <Icon
                      ...
                      style={{fontSize: 12, color: colors.theme_fg}}
                    />
                  </View>
                  <View
                    style={{
        ...
        <View style={{flexDirection: 'row', width: '100%'}}>
          <View
            ...
            <CardView cardElevation={5} cardMaxElevation={20} cornerRadius={10}>
              <TouchableOpacity
                onPress={set_data.bind(this, item.id, item.consultation_fee)}
                style={styles.button}>
                <Text
                  style={{
                    color: colors.theme_fg_three,
          ...
          <View
            ...
            <CardView cardElevation={5} cardMaxElevation={20} cornerRadius={10}>
              <TouchableOpacity
                onPress={get_slots.bind(this, item.id, item.consultation_fee)}
                style={styles.button}>
                <Text
                  style={{
                    color: colors.theme_fg_three,
        ...
        <CardView cardElevation={5} cardMaxElevation={5} cornerRadius={10}>
            ...
            <View
              ...
              <View
                ...
                <Image
                  ...
                  source={{uri: img_url + item.hospital_logo}}
                />
              </View>
            </View>
          ...
          <View
            ...
            <View style={{flexDirection: 'row'}}>
              <Icon
                type={Icons.Entypo}
                name="location"
                style={{fontSize: 15, color: colors.theme_fg}}
              />
              <View style={{margin: 3}} />
              <Text
                style={{fontSize: 13, color: colors.grey, fontFamily: regular}}>
                {item.address}
              </Text>
            </View>
            <View style={{margin: 5}} />
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{margin: 3}} />
              <Text
                style={{fontSize: 13, color: colors.grey, fontFamily: bold}}>
                {global.currency}
          ...
          <View style={{width: '100%', flexDirection: 'row', padding: 10}}>
            ...
            <View
              ...
              <TouchableOpacity
                onPress={hospital_details.bind(this, item)}
                style={{
                  width: '100%',
                  alignItems: 'center',
                  justifyContent: 'center',
                  backgroundColor: colors.regular_blue,
                  borderRadius: 5,
                  padding: 10,
                }}>
                <Text
