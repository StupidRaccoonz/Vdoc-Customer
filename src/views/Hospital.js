...
const Hospital = props => {
  ...
  const categories_list = () => {
    return categories.map(data => {
      return (
        <TouchableOpacity
          onPress={navigate.bind(this, data.id)}
          style={{
            alignItems: 'center',
            margin: 5,
            width: 120,
          ...
          <View style={{margin: 5}} />
          <Image
            style={{height: 50, width: 50, flex: 1, borderRadius: 10}}
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={{padding: 10}} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          <Text style={{fontSize: 14, color: colors.grey, fontFamily: regular}}>
            Search hospitals...
          </Text>
        </TouchableOpacity>
        <View style={{margin: 10}} />
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <View style={{alignSelf: 'flex-end', width: '25%'}}>
            <Text
              onPress={view_all.bind(this, 'Nearest Hospital', 1, doctor_list)}
              style={{
                fontSize: 12,
                color: colors.theme_bg_three,
                fontFamily: bold,
