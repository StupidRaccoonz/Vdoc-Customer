...
export const message_img = require('.././assets/img/message_icon.png');
export const calender_img = require('.././assets/img/calender_icon.png');
export const profile_img = require('.././assets/img/profile_icon.png');
